    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <button
              ...
              className="inline-flex items-center justify-center gap-2 px-4 py-2.5 bg-blue-600 hover:bg-blue-700 text-white rounded-lg font-semibold shadow-sm transition-all"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-6">
          ...
          <div className="bg-white rounded-xl shadow-sm p-5">
            <div className="text-sm font-medium text-gray-500 mb-1">Active Site</div>
            <div className="text-lg font-semibold text-blue-600 truncate">{activeSite?.name || "None"}</div>
          </div>
          <div className="bg-white rounded-xl shadow-sm p-5">
              ...
              {sites.map((site) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-start gap-4 mb-4">
                      <div
                        className={`flex-shrink-0 h-14 w-14 rounded-xl flex items-center justify-center ${
                          isCurrent ? "bg-blue-600" : "bg-gradient-to-br from-gray-700 to-gray-900"
                        }`}
                      >
                    ...
                    <div className="mt-4">
                      {isCurrent ? (
                        <div className="w-full text-center py-2 text-sm font-medium text-blue-600">
                          Currently Active
                        </div>
                      ) : (
                        <button
